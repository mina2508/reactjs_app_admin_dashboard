...
const Cart = () => {
  ...
  return (
    <div
      ...
      style={{ zIndex: 50000 }}
    >
      <div className="float-right   duration-1000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484B52] bg-white md:w-400 p-8">
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="text-3xl rounded-full p-3 mb-5 dark:text-white dark:hover:text-black hover:bg-light-gray mt-4 block "
          >
            <MdOutlineCancel />
          </button>
        </div>

  ...
  return (
    <div className="mt-6">
      <div className="flex flex-wrap  lg:flex-nowrap justify-center">
        ...
        rounded-xl w-full h-full lg:w-760 p-8 pt-9 
        m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center "
        >
          <div className="flex justify-between items-center">
            <div>
              <p className="font-bold text-gray-400">Earnings</p>
              <p className="text-2xl">88,555,777</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        <div
          className="bg-white dark:bg-secondary-dark-bg dark:text-gray-200 m-3 p-4
            ...
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  ...
                  cursor-pointer rounded-full text-white bg-green-400 ml-1.5
                  text-xs"
                  >
                    25%
                  </span>
